...
function AddUserModal({ onClose, onSuccess, existingUsers }) {
  ...
  async function handleSubmit(e) {
    ...
    } else if (existingUsers.some((u) => u.email.toLowerCase() === form.email.toLowerCase())) {
    ...
    <ModalWrapper title="Add User" onClose={onClose}>
      <form onSubmit={handleSubmit}>
        <div className="field">
          ...
          />
          {fieldErrors.name && (
            <span style={{ color: "#DC2626", fontSize: "12px" }}>{fieldErrors.name}</span>
          )}
        </div>
        ...
        <div className="field">
          ...
          />
          {fieldErrors.email && (
            <span style={{ color: "#DC2626", fontSize: "12px" }}>{fieldErrors.email}</span>
          )}
        </div>
        ...
        <div className="field">
          ...
          <input
            ...
            style={{ border: fieldErrors.password ? "1px solid #DC2626" : undefined }}
          />
          {fieldErrors.password && (
            <span style={{ color: "#DC2626", fontSize: "12px" }}>{fieldErrors.password}</span>
          )}
        </div>
